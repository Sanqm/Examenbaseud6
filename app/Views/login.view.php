     ...
     <!-- <p class="login-box-msg">Datos acceso: <i>admin@test.org - test</i></p>     -->  
      <form action="/login" method="post">
        <div class="input-group mb-3">
          <input type="text" name="dni" class="form-control" placeholder="DNI de usuario" value="<?php echo isset($dni) ? $dni : ''; ?>">
      ...
      <p class="login-box-msg text-danger"><?php echo isset($errores['login']) ? $errores['login'] : '';?></p>      
        <div class="row">
          <div class="col-12">            
